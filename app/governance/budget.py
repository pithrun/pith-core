...
from app.core.constants import GOV_EVENT_BUDGET_ALLOCATED
from app.governance.governance_context import GovernanceContext, ScoredConcept
...
def allocate_budget(
    ...
    *,
    ...
    Args:
        ...
        mode: Deadline degradation mode: full, lite, or emergency_minimal
        emit_event: Whether to append a governance event for the allocation
    ...
    skill_injections = getattr(gov_ctx, "skill_injections", []) if gov_ctx is not None else []
    for skill_id in skill_injections:
