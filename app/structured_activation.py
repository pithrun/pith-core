...
def _get_embeddings(enriched_concepts: list[dict]) -> dict[str, list[float]]:
    ...
    try:
        from app.embedding import embedding_engine  # [A1] Class singleton, not module fn
...
def _cache_get(key: str) -> dict | None:
    ...
    from app.config import SAL_CACHE_ENABLED, SAL_CACHE_TTL
...
def _cache_put(key: str, result: dict) -> None:
    ...
    from app.config import SAL_CACHE_ENABLED
...
def _mode_a(
    ...
    from app.probe_decomposition import decompose_and_retrieve
...
def _mode_c(
    ...
    from app.probe_decomposition import decompose_and_retrieve, check_probe_quality
