...
from app.constants import GOV_EVENT_BOOTSTRAP_COMPLETE
from app.currency import _days_since
from app.datetime_utils import _utc_now
from app.governance_context import GovernanceContext
...
def build_bootstrap(
    ...
    # Load all concepts with governance scores
    rows = conn.execute(
        """SELECT id, summary, concept_type, authority_score, currency_score,
