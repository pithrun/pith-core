...
CONTRADICTION_LLM_MODEL = "claude-haiku-4-5-20251001"  # Phase 3 v1.1: Haiku (was "gpt-4o-mini")
...
EDGE_LLM_MODEL = "claude-haiku-4-5-20251001"  # Same model as contradiction LLM

# PERF-001: Tier 3 LLM extraction
TIER3_LLM_MODEL = "claude-haiku-4-5-20251001"
...
PI_LLM_MODEL = os.environ.get("PITH_PI_LLM_MODEL", "claude-haiku-4-5-20251001")
...
EE_LLM_MODEL = TIER3_LLM_MODEL  # claude-haiku-4-5-20251001 — same as Tier 3
...
KA_LLM_MODEL = "claude-haiku-4-5-20251001"  # Same model as edge LLM
...
RETRIEVAL_WEIGHT_SIMILARITY = (
    0.61  # RETRIEVAL-038: Up from 0.55 — absorbed 0.06 from zeroed confidence weight
)
...
# PRICING-001: Daily learning budget per tier (concept creations per day)
DAILY_BUDGET_FREE = 50
DAILY_BUDGET_PRO = 500
DAILY_BUDGET_ENTERPRISE = 999999  # effectively unlimited
DAILY_BUDGET_DEV = 999999
DAILY_BUDGET_DEFAULT = 150  # current default, backwards compat
