...
class ConversationTurnRequest(BaseModel):
    ...
    max_concepts: int = Field(default=8, ge=1, le=50)  # TEST-088: floor=1 (0 returns empty silently), ceil=50
    ...
    # INGEST-037 Layer 3: Include verbatim fragments per activated concept
...
class SessionLearnResponse(BaseModel):
    ...
    learning_budget_remaining: int = 50  # daily budget remaining
