...
async def detect_contradiction_llm(
    ...
    try:
        ...
        # MONITOR-119: anthropic_llm_call counter for failure rate tracking
        try:
            from app.core.metrics_facade import metrics as _m23
            ...
            _m23.record("anthropic_llm_call", 1.0, {"caller": "contradiction_llm", "provider": CONTRADICTION_LLM_PROVIDER})
        except Exception:
            pass
        ...
        try:
            from app.core.metrics_facade import metrics as _m_fail

            _m_fail.record(
                "anthropic_llm_failure",
                1.0,
                {"caller": "contradiction_llm", "provider": CONTRADICTION_LLM_PROVIDER, "error": str(e)[:80]},
            )
        except Exception:
            pass
